...
const shareAlert = () => {
    const copyContent = `A fun personality test developed for Codedex"s April Month Challenge! Check it out here: https://krius2023.github.io/codedex-personality-test`;
    navigator.clipboard.writeText(`${copyContent}`);
    alert(`Content Copied:: ${copyContent}`);
}
